...
const FAQS = [
  ...
  { q: "Quantas análises posso fazer?", a: "No plano gratuito, 3 análises por mês. Mensal: 30/dia. Anual: 50/dia. Vitalício: ilimitadas." },
...
function PricingSection() {
  const plans = [
    ...
    },
    {
      ...
      features: ["30 análises por dia", "5 sugestões por análise", "Todos os apps", "Modo intenso e romântico", "Suporte prioritário"],
      cta: "Assinar agora",
    ...
    },
    {
      ...
      features: ["50 análises por dia", "Tudo do Mensal", "Equivale a R$12,25/mês", "Acesso completo 12 meses", "Suporte prioritário"],
      cta: "Assinar anual",
    ...
    },
    {
      ...
      features: ["Análises ilimitadas", "Acesso para sempre", "Novas features primeiro", "Acesso exclusivo beta", "Sem mensalidade jamais"],
