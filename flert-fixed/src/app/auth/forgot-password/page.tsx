...
.au-sub { font-size: 0.875rem; color: var(--tx-2); font-weight: 300; line-height: 1.7; }
...
.au-btn--ghost { background: transparent; color: var(--tx-2); border: 1px solid var(--bd); }
.au-btn--ghost:hover:not(:disabled) { background: transparent; border-color: var(--bd-2); color: var(--tx); }
...
.au-link-sm { font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase; font-weight: 600; color: var(--tx-3); transition: color 0.2s; display: inline-flex; align-items: center; gap: 0.5rem; }
.au-link-sm:hover { color: var(--tx-2); }
...
.au-success p { font-size: 0.875rem; color: var(--tx-2); font-weight: 300; line-height: 1.75; }
      ...
      <div className="au">
        <div className="au-left">
          ...
          <div className="au-left-body">
            ...
            <h2 className="au-left-title">Acontece<br />com todos.<br /><em>Sem problema.</em></h2>
